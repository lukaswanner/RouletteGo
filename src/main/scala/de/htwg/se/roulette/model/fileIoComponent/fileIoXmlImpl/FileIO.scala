...
class FileIO extends FileIOInterface {
  override def load: Playboard = {
    ...
    val file = scala.xml.XML.loadFile("C:\\Users\\lu851wan\\IdeaProjects\\RouletteGo\\src\\main\\scala\\de.htwg.se.roulette.FILES\\test.xml")
  ...
  override def save(playboard: playboardInterface): Unit = {
    import java.io._
    val pw = new PrintWriter(new File("C:\\Users\\lu851wan\\IdeaProjects\\RouletteGo\\src\\main\\scala\\de.htwg.se.roulette.FILES\\test.xml"))
